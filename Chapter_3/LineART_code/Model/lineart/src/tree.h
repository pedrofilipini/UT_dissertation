...
public:
   ...
   friend double bd_linear(tree& x, xinfo& xi, dinfo& di, pinfo& pi, RNG& gen, std::vector<tree::tree_cp>& node_pointers);
   friend void fit_linear(tree& t, xinfo& xi, dinfo& di, double* fv, std::vector<tree::tree_cp>& node_pointers, bool populate);
   friend double fit_i_linear(size_t& i, std::vector<tree>& t, xinfo& xi, dinfo& di);
   friend mat coef_basis(tree& t, xinfo& xi, dinfo& di);
   friend mat coef_linear(tree& t, xinfo& xi, dinfo& di);
