  ...
  for(i in c(large,(1:length(lista_sz))[-large])){
    ...
    nt=200
          ...
          foreach(hh = 1:simrep, .packages=c('lbart','dbarts','dplyr','magrittr')) %dopar%  {
            ...
            times_bart <- difftime(Sys.time(), simtime, units = "secs")[[1]]
            ...
            times1 <- 0#times_lbart
            times2 <- times_bart
            times3 <- 0#times_soft
            
            r1_train <- 0#sqrt(mean((apply(lbart_default$mu_post, 2, mean)-y_train)^2))
            r2_train <- sqrt(mean((apply(bart_default$mu_post, 2, mean)-y_train)^2))
            r3_train <- 0#sqrt(mean((apply(soft_default$y_hat_train, 2, mean)-y_train)^2))
            
            r1 <- 0#sqrt(mean((apply(lbart_default$mu_est_post, 2, mean)-y_test)^2))
            r2 <- sqrt(mean((apply(bart_default$mu_est_post, 2, mean)-y_test)^2))
            r3 <- 0#sqrt(mean((apply(soft_default$y_hat_test, 2, mean)-y_test)^2))
            
            cove1 <- 0#mean(dplyr::between(y_train,apply(lbart_default$mu_post, 2, quantile, 0.025), apply(lbart_default$mu_post, 2, quantile, 0.975)))
            cove2 <- mean(dplyr::between(y_train,apply(bart_default$mu_post, 2, quantile, 0.025), apply(bart_default$mu_post, 2, quantile, 0.975)))
            ...
            covep1 <- 0#mean(dplyr::between(y_test,apply(lbart_default$mu_est_post, 2, quantile, 0.025), apply(lbart_default$mu_est_post, 2, quantile, 0.975)))
            covep2 <- mean(dplyr::between(y_test,apply(bart_default$mu_est_post, 2, quantile, 0.025), apply(bart_default$mu_est_post, 2, quantile, 0.975)))
            ...
            rangep1 <- 0#mean(apply(lbart_default$mu_est_post, 2, quantile, 0.975)-apply(lbart_default$mu_est_post, 2, quantile, 0.025))
            rangep2 <- mean(apply(bart_default$mu_est_post, 2, quantile, 0.975)-apply(bart_default$mu_est_post, 2, quantile, 0.025))
            rangep3 <- 0#mean(apply(soft_default$y_hat_test, 2, quantile, 0.975)-apply(soft_default$y_hat_test, 2, quantile, 0.025))
            
            range1 <- 0#mean(apply(lbart_default$mu_post, 2, quantile, 0.975)-apply(lbart_default$mu_post, 2, quantile, 0.025))
            range2 <- mean(apply(bart_default$mu_post, 2, quantile, 0.975)-apply(bart_default$mu_post, 2, quantile, 0.025))
            ...
            write.table(times_vec, paste0("times_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(rmse_train, paste0("rmse_train_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(rmse, paste0("rmse_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(coverage, paste0("coverage_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(coveragep, paste0("coveragep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(range, paste0("range_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
            write.table(rangep, paste0("rangep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")
          ...
          for(hh in 1:simrep){
            times_matrix[hh,] <- read.csv(paste0("times_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";") %>% t() %>% as.numeric()
            rmse_matrix_train[hh,] <- read.csv(paste0("rmse_train_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")%>% t() %>% as.numeric()
            rmse_matrix[hh,] <- read.csv(paste0("rmse_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";") %>% t() %>% as.numeric()
            coverage_matrix[hh,] <- read.csv(paste0("coverage_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";") %>% t() %>% as.numeric()
            coveragep_matrix[hh,] <- read.csv(paste0("coveragep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";") %>% t() %>% as.numeric()
            range_matrix[hh,] <- read.csv(paste0("range_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")%>% t() %>% as.numeric()
            rangep_matrix[hh,] <- read.csv(paste0("rangep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"__hh_",hh,"_partial.csv"), sep = ";")%>% t() %>% as.numeric()
          }
          ...
          write.table(times_matrix, paste0("times_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(rmse_matrix_train, paste0("rmse_train_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(rmse_matrix, paste0("rmse_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(coverage_matrix, paste0("coverage_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(coveragep_matrix, paste0("coveragep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(range_matrix, paste0("range_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
          write.table(rangep_matrix, paste0("rangep_cv_bart__a_", alpha, "__b_",beta,"__nt_",nt,"__i_",i,"_total.csv"), sep = ";")
