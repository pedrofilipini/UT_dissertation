...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type update_ls(update_lsSEXP);
...
RcppExport SEXP _multibart_cSelect(SEXP x_SEXP, SEXP y_SEXP, SEXP c_maxSEXP, SEXP valueSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _multibart_gpCore(SEXP y_SEXP, SEXP Omega_conSEXP, SEXP Phi_conSEXP, SEXP l_conSEXP, SEXP LSEXP, SEXP burnSEXP, SEXP ndSEXP, SEXP thinSEXP, SEXP nuSEXP, SEXP lambdaSEXP, SEXP Sigma0_conSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type y_(y_SEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type upper_bd(upper_bdSEXP);
    Rcpp::traits::input_parameter< bool >::type probit(probitSEXP);
    rcpp_result_gen = Rcpp::wrap(multibart(y_, bart_specs, bart_designs, random_des, random_var, random_var_ix, random_var_df, randeff_scales, burn, nd, thin, lambda, nu, treef_name_, est_mod_fits, est_con_fits, prior_sample, status_interval, lower_bd, upper_bd, probit));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_multibart_bcfCore", (DL_FUNC) &_multibart_bcfCore, 65},
    {"_multibart_cSelect", (DL_FUNC) &_multibart_cSelect, 4},
    {"_multibart_gpCore", (DL_FUNC) &_multibart_gpCore, 11},
    {"_multibart_multibart", (DL_FUNC) &_multibart_multibart, 21},
    {NULL, NULL, 0}
};
